...
选择TLS的一大原因是希望保护以及尊重用户的隐私，而早期的评估结果也表明，在TLS上建立新的协议更有可能获得成功。而其中部分原因是人们普遍认为任何来自80端口的流量都是基于HTTP 1.1及其某个变种的，而不是另外一种全新的协议。
...
虽然有些浏览器厂商的发言人宣称他们不会实现这样的http2会话方式，但IE团队曾公开表示他们会实现虽然他们从未真正实现，与此同时，curl也已经支持了这种方式。
